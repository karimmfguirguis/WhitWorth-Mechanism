...
for th2=1:1:361
Position_QR_Array(:,th2)=fsolve(@Position_QR, [540,68],options, (th2-1));
...
for th2=1:1:361
Position_SC_Array(:,th2)=fsolve(@Position_SC, [60,700],options, th4(th2));
th5 = Position_SC_Array(1,:)+360;
...
for th2=1:1:361
Velocity_QR_Array(:,th2)=fsolve(@Velocity_QR, [1843.7,1.44],options,th2,10,r3(th2),th4(th2));
...
for th2=1:1:361
Acceleration_QR_Array(:,th2)=fsolve(@Acc_QR, [32.25,-6.4],options,th2,10,w3(th2),r3(th2),r3dot(th2),th4(th2));
